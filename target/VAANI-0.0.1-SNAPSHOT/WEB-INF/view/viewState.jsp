											...
											<tbody>
												<c:forEach items="${statelist}" var="i">
													<tr>
														...
														<td><a href="editState.html?editStateId=${i.stateId}"><input type="button" class="btn btn-primary" value="Edit"/></a></td>
														<td><a href="deleteState.html?deleteStateId=${i.stateId}"><input type="button" class="btn btn-danger" value="Delete" /></a></td>
													</tr>
												</c:forEach>
											</tbody>
											<tfoot>
