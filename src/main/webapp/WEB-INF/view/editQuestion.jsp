...
<title>VAANI Admin - Edit Question</title>
				...
				<section class="content">
					...
					<div class="box">
						...
						<div class="box-body">
							<div class="row">
								<div class="col">
									<form:form novalidate="novalidate" action="updateQuestion.html" method="post" modelAttribute="editData">
										<form:hidden path="questionId" value="${i.questionId}"/>
										<div class="row">
											<div class="col-12">
												<div class="form-group">
													<h5>Enter Question <span class="text-danger">*</span></h5>
													<div class="controls">
														<form:input type="text" name="text" path="question" class="form-control" placeholder="question" required="required" data-validation-required-message="This field is required" /> 
													</div>
												</div>
												<div class="form-group">
													<h5>Description</h5>
													<div class="controls">
														<form:textarea name="textarea" id="textarea" path="questionDescription" class="form-control" placeholder="Write Description Here"></form:textarea>
													</div>
												</div>
