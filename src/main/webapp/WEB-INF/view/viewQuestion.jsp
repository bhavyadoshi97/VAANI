											...
											<tbody>
												<c:forEach items="${questionlist}" var="i">
													<tr>
														...
														<td><a href="editQuestion.html?editQuestionId=${i.questionId}"><input type="button" class="btn btn-primary" value="Edit"/></a></td>
														<td><a href="deleteQuestion.html?deleteQuestionId=${i.questionId}"><input type="button" class="btn btn-danger" value="Delete" /></a></td>
													</tr>
												</c:forEach>
											</tbody>
											<tfoot>
