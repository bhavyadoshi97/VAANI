				...
				<section class="content">
					...
					<div class="box">
						...
						<div class="box-body">
							<div class="row">
								<div class="col">
									<form:form novalidate="novalidate" action="/admin/insertCity.html" modelAttribute="cityData">
										<div class="row">
											<div class="col-12">
												<div class="form-group">
													...
													<div class="controls">
														<form:select path="s1.stateId" required="required" class="form-control">
															...
															<form:options itemLabel="stateName" itemValue="stateId" items="${statelist1}"/>
														</form:select>
													</div>
												</div>
												<div class="form-group">
