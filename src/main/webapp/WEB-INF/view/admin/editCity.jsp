...
<title>VAANI Admin - Edit City</title>
				...
				<section class="content">
					...
					<div class="box">
						...
						<div class="box-body">
							<div class="row">
								<div class="col">
									<form:form novalidate="novalidate" action="/admin/updateCity.html" modelAttribute="editcityData">
										...
										<div class="row">
											<div class="col-12">
												<div class="form-group">
													...
													<div class="controls">
														<form:select path="s1.stateId" required="required" class="form-control">
															<form:options itemLabel="s1.stateName" itemValue="s1.stateId" items="${statelist1}"/>
														</form:select>
													</div>
												</div>
												<div class="form-group">
													...
													<div class="controls">
														<form:input type="text" name="text" path="cityName" class="form-control" placeholder="City Name" required="required" data-validation-required-message="This field is required" /> 
													</div>
												</div>
												<div class="form-group">
													<h5>Description</h5>
													<div class="controls">
														<form:textarea name="textarea" id="textarea" path="cityDescription" class="form-control" placeholder="Write Description Here"></form:textarea>
													</div>
												</div>
											</div>
										</div>
