...
<title>VAANI Admin - View Disabled User</title>
			...
			<div class="container">
				...
				<div class="content-header">
					<div class="d-flex align-items-center">
						<div class="mr-auto">
							<h3 class="page-title">Disabled User</h3>
							<div class="d-inline-block align-items-center">
							<nav>
								<ol class="breadcrumb">
									<li class="breadcrumb-item"><a href="/admin/index"><i class="mdi mdi-home-outline"></i></a></li>
									<li class="breadcrumb-item" aria-current="page">Disabled User</li>
									<li class="breadcrumb-item active" aria-current="page">View Disabled User</li>
								</ol>
							</nav>
							</div>
						</div>
						...
						<div class="col-12">
							<div class="box">
								<div class="box-header">
									<h4 class="box-title">List of Disabled Users</h4>
								</div>
								<div class="box-body">
									<div class="table-responsive">
										<table id="complex_header"
											...
											<tbody>
												<c:forEach items="${disabledUserList}" var="i">
													<tr>
														<td>${i.disabledUsername}</td>
														<td>${i.disabledUserUniqueId}</td>
														<td>${i.dateOfBirth}</td>
														<td>${i.gender}</td>
														<td>${i.dateOfIssue}</td>
														<td>${i.dateOfExpiry}</td>
														<td><a href="/admin/editDisabledUser.html?editDisabledUserId=${i.disabledUserId}"><input type="button" class="btn btn-primary" value="Edit"/></a></td>
														<td><a href="/admin/deleteDisabledUser.html?deleteDisabledUserId=${i.disabledUserId}"><input type="button" class="btn btn-danger" value="Delete" /></a></td>
													</tr>
												</c:forEach>
											</tbody>
											<tfoot>
