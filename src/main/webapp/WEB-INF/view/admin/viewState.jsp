...
<title>VAANI Admin - View State</title>
						...
						<div class="col-12">
							<div class="box">
								<div class="box-header">
									<h4 class="box-title">List of States</h4>
								</div>
								<div class="box-body">
											...
											<tbody>
												<c:forEach items="${statelist}" var="i">
													<tr>
														...
														<td><a href="/admin/editState.html?editStateId=${i.stateId}"><input type="button" class="btn btn-primary" value="Edit"/></a></td>
														<td><a href="/admin/deleteState.html?deleteStateId=${i.stateId}"><input type="button" class="btn btn-danger" value="Delete" /></a></td>
													</tr>
												</c:forEach>
											</tbody>
											<tfoot>
