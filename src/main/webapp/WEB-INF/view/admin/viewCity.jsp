...
<title>VAANI Admin - View City</title>
						...
						<div class="col-12">
							<div class="box">
								<div class="box-header">
									<h4 class="box-title">List of Cities</h4>
								</div>
								<div class="box-body">
											...
											<tbody>
												<c:forEach items="${citylist}" var="i">
													<tr>
														<td>${i.cityId}</td>
														<td>${i.cityName}</td>
														<td>${i.s1.stateName}</td>
														<td>${i.cityDescription}</td>
														<td><a href="/admin/editCity.html?editCityId=${i.cityId}"><input type="button" class="btn btn-primary" value="Edit" /></a></td>
														<td><a href="/admin/deleteCity.html?deleteCityId=${i.cityId}"><input type="button" class="btn btn-danger" value="Delete" /></a></td>
													</tr>
												</c:forEach>
											</tbody>
											<tfoot>
