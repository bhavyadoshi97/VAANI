											...
											<tbody>
												<c:forEach items="${citylist}" var="i">
													<tr>
														...
														<td><a href="editCity.html?editCityId=${i.cityId}"><input type="button" class="btn btn-primary" value="Edit" /></a></td>
														<td><a href="deleteCity.html?deleteCityId=${i.cityId}"><input type="button" class="btn btn-danger" value="Delete" /></a></td>
													</tr>
												</c:forEach>
											</tbody>
											<tfoot>
