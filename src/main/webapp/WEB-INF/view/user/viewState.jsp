											...
											<tbody>
												<c:forEach items="${statelist}" var="i">
													<tr>
														...
														<td><a href="/user/editState.html?editStateId=${i.stateId}"><input type="button" class="btn btn-primary" value="Edit"/></a></td>
														<td><a href="/user/deleteState.html?deleteStateId=${i.stateId}"><input type="button" class="btn btn-danger" value="Delete" /></a></td>
													</tr>
												</c:forEach>
											</tbody>
											<tfoot>
