											...
											<tbody>
												<c:forEach items="${disabledUserList}" var="i">
													<tr>
														...
														<td><a href="/user/editDisabledUser.html?editDisabledUserId=${i.disabledUserId}"><input type="button" class="btn btn-primary" value="Edit"/></a></td>
														<td><a href="/user/deleteDisabledUser.html?deleteDisabledUserId=${i.disabledUserId}"><input type="button" class="btn btn-danger" value="Delete" /></a></td>
													</tr>
												</c:forEach>
											</tbody>
											<tfoot>
