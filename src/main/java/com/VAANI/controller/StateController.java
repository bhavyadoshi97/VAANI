...
public class StateController {
	...
	@RequestMapping(value="/addState.html")
	public ModelAndView loadaddState()
	{
		return new ModelAndView("addState","stateData",new StateVO());
	}
	...
	@RequestMapping(value="/viewState.html")
	public ModelAndView loadviewState()
	{
		List viewStateList=this.stateService.viewState();
		return new ModelAndView("viewState","statelist",viewStateList);
	}
	
	@RequestMapping(value="/editState.html")
	public ModelAndView loadeditState(@RequestParam("editStateId") int editStateId,StateVO stateVO1)
	{
		...
		return new ModelAndView("editState","editData",(StateVO)editStateList.get(0));
	}
	
	@RequestMapping(value="/updateState.html")
	...
	@RequestMapping(value="/deleteState.html")
