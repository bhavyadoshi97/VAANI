...
<html lang="en">
  <head>
    ...
    <title>VAANI Admin - Dashboard</title>
	  ...
	  <div class="container">
		...
		<section class="content">
					  ...
					  <div class="box-body">
						  <div class="flexbox">
							  ...
							  <div>
								  ...
								  <p class="mb-0"><i class="ion-ios-arrow-up text-success mr-10"></i>New Users</p>		  
							  </div>				
						  </div>
					  </div>
				  </div>
				  ...
				  <div class="box">		
					  <div class="box-body">
						  <div class="flexbox">
							  ...
							  <div>
								  <h3 class="countnm mb-5">%90</h3>
								  <p class="mb-0"><i class="ion-ios-arrow-up text-success mr-10"></i>Impressions</p>
							  </div>			
						  </div>
					  </div>
				  </div>
		  ...
		  <div class="row">
			<div class="col-xl-4 col-12">
			  <!-- small box -->
			  <div class="small-box box-inverse bg-img" style="background-image: url(adminResources/images/6.jpg);" data-overlay="5">
				<div class="inner">
				  <h3>255</h3>
			...
			<div class="col-xl-4 col-12">
			  <!-- small box -->
			  <div class="small-box box-inverse bg-img" style="background-image: url(adminResources/images/9.jpg);" data-overlay="5">
				<div class="inner">
			...
			<div class="col-xl-4 col-12">
			  <!-- small box -->
			  <div class="small-box box-inverse bg-img" style="background-image: url(adminResources/images/8.jpg);" data-overlay="5">
				<div class="inner">
				  <h3>78</h3>
